...
tabs = [
    ...
    "src/components/OperatorsTab.tsx",
    "src/components/ChartersTab.tsx",
    "src/components/company-Profile.tsx",
    "src/components/SettingsTab.tsx",
    "src/components/NotificationsManagementTab.tsx",
    "src/components/TeamMessagingTab.tsx",
    "src/components/TripActivityTab.tsx"
]
