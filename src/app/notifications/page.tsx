...
export default function NotificationsPage() {
  ...
  if (!user?.id) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-brand-50 to-gray-50 flex items-center justify-center p-4">
          ...
          <div className="mb-6 flex gap-2 flex-wrap">
            {unreadCount > 0 && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-coral-500 text-white rounded-lg hover:bg-coral-600 disabled:opacity-50 transition"
              >
                ...
                >
                  <div className="flex gap-4">
                    ...
                    <div className={`shrink-0 w-10 h-10 rounded-full flex items-center justify-center ${
                      notification.isRead ? 'bg-gray-100' : 'bg-brand-100'
                    }`}>
                      {notification.isRead ? (
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className={`font-semibold text-gray-900 mb-1 ${
                        notification.isRead ? '' : 'text-brand-900'
                      }`}>
                        {notification.title}
                      </h3>
            ...
            {hasMore && (
              <div className="mt-8 flex justify-center">
                <button
                  ...
                  disabled={loading}
                  className="px-6 py-2 bg-brand-700 text-white rounded-lg hover:bg-brand-800 disabled:opacity-50 transition inline-flex items-center gap-2"
                >
