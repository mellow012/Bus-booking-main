import { LayoutDashboard, MapPin, QrCode, Users, DollarSign, FileText, User, Settings } from 'lucide-react';

export const TABS = [
  { id: 'dashboard' as const, label: 'Dashboard', icon: LayoutDashboard },
  { id: 'my-trips' as const, label: 'My Trips', icon: MapPin },
  { id: 'ticket-scanning' as const, label: 'Ticket Scanning', icon: QrCode },
