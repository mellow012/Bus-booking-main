...
export default function OperatorSubNav({ tabs, activeTab, onTabChange }: OperatorSubNavProps) {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-x-auto no-scrollbar mb-6">
      <nav className="flex min-w-max divide-x divide-gray-100">
        {tabs.map((tab) => {
