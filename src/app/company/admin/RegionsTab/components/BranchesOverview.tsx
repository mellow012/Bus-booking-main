...
export default function AllBranchesOverview({ trips, buses }: AllBranchesOverviewProps) {
  return (
            ...
            return (
              <div key={schedule.id} className="rounded-2xl border border-gray-200 bg-gray-50 p-4 shadow-sm">
                ...
                <div className="text-sm text-gray-600 space-y-1">
                  ...
                  <p>
                    <span className="font-medium text-gray-900">Bus:</span> {buses.find((b: Bus) => b.id === schedule.busId)?.licensePlate || 'TBD'}
                  </p>
                </div>
              </div>
            );
