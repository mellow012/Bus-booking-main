...
import { Map, Clock, Currency, Bus as BusIcon, Armchair, User, Loader2, AlertCircle, Star as StarIcon } from 'lucide-react';
...
const BusDetailsPage: React.FC = () => {
  const {
    ...
    modalOpen, setModalOpen, actionLoading, reviewsData,
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6">
          ...
          {/* Removed redundant tabs from this fallback page */}
