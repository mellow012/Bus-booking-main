...
        ...prev,
        // Ensure initial state conforms to the PassengerDetail interface
        { name: '', age: 0, gender: 'male', seatNumber: seat } as PassengerDetails,
      ]);
    }
  };
...
      ...p, 
      // Cast gender value to the specific union type if the field is 'gender'
...
        // Added missing required fields from previous fix (assuming required for Booking type)
...
        updatedAt: Timestamp.now(), // This remains Timestamp if Schedule interface expects Timestamp
      });
