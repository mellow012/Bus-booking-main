...
export default function OfflinePage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-slate-900 via-brand-950/80 to-slate-950 relative overflow-hidden">
      {/* Background blobs */}
      <div className="absolute -top-40 -right-40 w-[500px] h-[500px] rounded-full bg-brand-500/10 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-32 -left-32 w-[400px] h-[400px] rounded-full bg-brand-500/10 blur-3xl pointer-events-none" />
      ...
      <div className="relative flex flex-col items-center gap-6 px-8 text-center max-w-sm">
        ...
        <button
          ...
          className="mt-2 px-6 py-3 bg-coral-500 hover:bg-coral-600 text-white font-semibold rounded-xl transition-colors shadow-lg shadow-coral-950/40 text-sm"
        >
          Try Again
        </button>
      </div>
