          ...
          {success ? (
            ...
            <form onSubmit={handleReset} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="appearance-none block w-full px-3 py-2.5 pl-10 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-700 focus:border-brand-700 transition-colors duration-200 disabled:bg-gray-50"
                    placeholder="••••••••"
                  />
              ...
              <Button
                ...
                className="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-coral-500 hover:bg-coral-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-coral-500 transition-all duration-200"
              >
                {isSubmitting ? (
                  <>
