        ...
        >
          {popularRoutes.map((route: any, i: number) => (
            <button
              ...
              className="snap-start flex-shrink-0 w-64 bg-white p-5 rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-xl hover:border-brand-200 transition-all text-left group"
            >
              <div className="flex items-center justify-between mb-4">
                <div className="w-10 h-10 rounded-2xl bg-brand-50 flex items-center justify-center text-brand-700 group-hover:bg-brand-700 group-hover:text-white transition-colors">
                  <Navigation className="w-5 h-5" />
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-bold text-gray-400 uppercase tracking-tight">Starting from</p>
                  <p className="text-sm font-black text-brand-700">MWK {route.price.toLocaleString()}</p>
                </div>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-gray-50 flex items-center justify-between">
                ...
                <ArrowRight className="w-4 h-4 text-gray-300 group-hover:text-brand-700 group-hover:translate-x-1 transition-all" />
              </div>
            </button>
          ))}
        </div>
