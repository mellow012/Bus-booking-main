    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-32 space-y-4">
          ...
          <p className="text-[11px] font-bold text-gray-400 uppercase tracking-widest">Decrypting Activity Stream...</p>
        </div>
      ) : filteredLogs.length === 0 ? (
        <div className="text-center py-32 bg-white rounded-2xl border-2 border-dashed border-gray-100 shadow-sm">
          <div className="w-20 h-20 bg-gray-50 rounded-2xl flex items-center justify-center mx-auto mb-6">
            <BusIcon className="w-10 h-10 text-gray-200" />
          </div>
          <h3 className="text-lg font-bold text-gray-900 uppercase">Static Field Detected</h3>
            ...
            {filteredLogs.map((log, idx) => {
              ...
              return (
                <div key={log.id} className="flex gap-8 group">
                  ...
                  <div className="flex-1 bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-sm transition-all duration-500 group-hover:border-indigo-100 relative overflow-hidden">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative z-10">
                      <div>
                        <div className="flex items-center gap-3 mb-1">
                          <span className="text-[9px] font-bold text-indigo-600 bg-indigo-50 px-2.5 py-1 rounded-lg uppercase tracking-widest border border-indigo-100">
                        ...
                        <h4 className="text-lg font-bold text-gray-900 tracking-tight group-hover:text-indigo-600 transition-colors">
                          {log.description}
                        </h4>
                        {route && (
                      ...
                      <div className="flex items-center gap-3 self-end md:self-auto">
                        <div className="text-right mr-2">
                          <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest">Logged By</p>
