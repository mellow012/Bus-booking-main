...
import {
  Building2, User2, CreditCard, Activity, Wifi, User, X, Loader2,
} from 'lucide-react';
    ...
    <aside className={`w-64 bg-white border-r border-gray-100 h-screen fixed lg:sticky top-0 flex flex-col z-50 overflow-hidden transition-transform duration-300 ${isMobileOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
      <div className="p-6 mb-2 flex items-center justify-between">
        <div className="flex items-center space-x-3 min-w-0 flex-1">
          ...
          <div className="min-w-0">
            <h1 className="font-bold text-brand-800 text-[15px] leading-tight truncate">Super Admin</h1>
          </div>
        </div>
      ...
      <div className="p-4 bg-gray-50/50 m-3 rounded-2xl">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-brand-800 flex items-center justify-center text-[10px] font-black text-white">SA</div>
          <div className="min-w-0">
