    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
      <div className="flex items-center justify-between gap-4 flex-wrap">
        <div className="flex items-center gap-3 flex-1 min-w-0">
          <ExclamationTriangleIcon className="w-5 h-5 text-brand-700 flex-shrink-0" />
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          <Link href="/profile" className="inline-block">
            <Button size="sm" className="h-8 px-4 bg-coral-500 text-white hover:bg-coral-600 transition-colors">
              Complete profile
            </Button>
          </Link>
          <button
            onClick={onDismiss}
            className="text-brand-500 hover:text-brand-700 p-1 rounded-full hover:bg-brand-100 transition-colors ml-2"
