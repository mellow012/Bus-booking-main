...
export function Hero() {
  return (
    // Hero bg: brand-900 → brand-800 → brand-700 — white text contrast = 12:1 / 7.8:1 (AAA)
    <section className="relative overflow-hidden bg-gradient-to-br from-brand-900 via-brand-800 to-brand-700">
      {/* Background decoration */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        {/* brand-400/10 = decorative only, low opacity — no contrast issue */}
        <div className="absolute -top-40 -right-40 w-[600px] h-[600px] rounded-full bg-brand-400/10 blur-3xl"/>
        {/* coral-400/10 = warm accent blob — decorative only */}
        <div className="absolute -bottom-20 -left-20 w-[400px] h-[400px] rounded-full bg-coral-400/10 blur-3xl"/>
          ...
          <div className="relative w-full max-w-[420px] sm:max-w-lg lg:max-w-2xl">
            ...
            <div className="absolute top-2 -right-2 sm:top-4 sm:-right-4 bg-white rounded-2xl shadow-xl px-3 sm:px-4 py-2 sm:py-3 flex items-center gap-2 sm:gap-2.5 anim-scale-in delay-300">
              <div className="w-7 h-7 sm:w-8 sm:h-8 bg-emerald-100 rounded-xl flex items-center justify-center shrink-0">
                {/* emerald stays — semantic success state, correct contrast */}
                <CheckCircle className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600"/>
              </div>
              <div>
                <p className="text-[10px] sm:text-xs text-gray-500">Instant confirm</p>
                <p className="text-xs sm:text-sm font-bold text-gray-900">Booked!</p>
              </div>
            </div>
            <div className="absolute -bottom-1 -left-2 sm:-bottom-2 sm:-left-4 bg-white rounded-2xl shadow-xl px-3 sm:px-4 py-2 sm:py-3 flex items-center gap-2 sm:gap-2.5 anim-scale-in delay-400">
              ...
              <div className="w-7 h-7 sm:w-8 sm:h-8 bg-brand-50 rounded-xl flex items-center justify-center shrink-0">
                <BusIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-brand-700"/>
              </div>
              <div>
                <p className="text-[10px] sm:text-xs text-gray-500">Routes available</p>
                <p className="text-xs sm:text-sm font-bold text-gray-900">20+ Routes</p>
              </div>
            </div>
          </div>
        </div>
