          ...
          <div className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
            <div className="col-span-1">
              <div className="flex items-center justify-between mb-1.5 ml-1 mr-1">
                ...
                {/* brand-700 text on white = 7.8:1 (AAA) ✓ */}
                <button
                  type="button"
                  onClick={() => setShowCityPicker(true)}
                  className="flex items-center gap-1 text-[10px] font-bold text-brand-700 hover:text-brand-600 transition-colors uppercase tracking-wider"
                >
              ...
              <div className="space-y-2">
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-9 pr-3 h-11 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-brand-700 accent-brand-700"
                  />
                </div>
            ...
            <div className="col-span-1">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-9 pr-3 h-11 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-brand-700"
                />
              </div>
            </div>
            <div className="col-span-2 lg:col-span-1 flex items-end">
              {/* Search CTA — coral-500 | white bold text = 3.4:1 (large-text AA ✓) */}
              {/* Coral pops against the teal hero bg above for visual hierarchy */}
              <button 
                onClick={handleSearch} 
                className="w-full h-11 flex items-center justify-center gap-2 bg-coral-500 hover:bg-coral-600 text-white font-semibold rounded-xl transition-all shadow-lg active:scale-95"
