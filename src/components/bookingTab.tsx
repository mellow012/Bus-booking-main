            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200">
                {paginatedBookings.length === 0 ? (
                  <tr>
                    <td colSpan={role === "company_admin" ? 8 : 7} className="px-6 py-12 text-center text-gray-500">
                  ...
                  paginatedBookings.map((booking) => {
                    ...
                    return (
                      <tr key={booking.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        {(userProfile?.role === 'company_admin' || userProfile?.role === 'operator') && (
                          <td className="px-6 py-4">
            ...
            return (
              <div key={scheduleId}>
                ...
                <SeatSelectionView
                  ...
                  onSeatClick={setSelectedBooking}
                />
              </div>
            );
          })}
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4" onClick={() => setSelectedBooking(null)}>
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Actions */}
              {role === "company_admin" && selectedBooking.bookingStatus === "pending" && (
                <div className="border-t pt-4 flex gap-2">
                  ...
                  <Button
                    ...
                    className="flex-1"
                    onClick={() => {
                      handleUpdateBookingStatus(selectedBooking.id, "cancelled", "Cancelled by admin");
                      setSelectedBooking(null);
                    }}
                    disabled={actionLoading[selectedBooking.id]}
                  >
