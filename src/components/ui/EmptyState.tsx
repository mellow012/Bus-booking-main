  ...
  return (
    ...
    >
      ...
      {actionLabel && onAction && (
        <button
          onClick={onAction}
          className="mt-6 inline-flex items-center gap-2 rounded-lg bg-coral-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-coral-600 transition-all"
        >
          {actionLabel}
        </button>
      )}
