...
const SettingsTab = ({ company, setCompany, setError, setSuccess }) => {
            ...
            <>
              <div>
                <div className="flex items-center space-x-2">
                  ...
                  <HelpCircle className="w-4 h-4 text-gray-400 cursor-help" title="Use your PayChangu test public key during development." />
                </div>
                <Input
                  id="paychanguToken"
