// Run this script using tsx:
// npx tsx scripts/deleteMellowSchedules.ts
...
async function main() {
  ...
  // We must delete dependent records manually if cascade delete is not enabled at the DB level.
  try {
